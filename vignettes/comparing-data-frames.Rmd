---
title: "Comparing Data Frames with Different"
author: "Garrick Aden-Buie"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Comparing Data Frames with Different}
...
<!-- TODO FIXME @garrick Update Vignette -->
...
```{r }
x <- make_core_fake(10, 10^3) %>%
  add_ids(n_ids = c(50^4, 600))
...
Resulting in two data frames that are similar but unique.
